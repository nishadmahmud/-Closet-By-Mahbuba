// Static size chart fallback when API omits size_chart_category
    ...
    howToMeasure: [
      {
        part: "Foot Length",
        instruction:
          "Place your foot on a piece of paper and trace around it. Measure from the heel to the longest toe.",
      },
    ],
  },
  dresses: {
...
export function detectProductType(productName, categoryName = "", subcategoryName = "") {
